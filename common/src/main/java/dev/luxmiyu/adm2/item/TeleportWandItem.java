    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            if (player.isSneaking()) {
                ...
                player.sendMessage(Text.translatable("message.adm2.teleport_success", blockName, surfacePos.toShortString()), true);
            } else {
                ...
                player.sendMessage(Text.translatable("message.adm2.teleport_success", blockName, blockPos.toShortString()), true);
            }
